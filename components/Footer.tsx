...
const Footer: React.FC<FooterProps> = ({ 
  ...
  return (
    <footer className="bg-slate-50 border-t border-slate-200 pt-12 pb-10 md:pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-600 transition-all text-slate-400"
                aria-label="LinkedIn"
              >
        ...
        {/* Bottom Section - Always Visible, Centered on Mobile */}
        <div className="pt-10 md:border-t md:border-slate-200 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-center md:text-left">
          <p className="text-slate-400 text-[10px] md:text-sm italic tracking-widest uppercase font-bold">
            Designed for Scale. Built for Growth.
          </p>
          <p className="text-slate-300 md:text-slate-400 text-[10px] md:text-sm font-bold">
